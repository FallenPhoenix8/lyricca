...
export function ExpandablePanel({
  ...
  return (
    ...
    >
      <button
        className={cn(
          "font-bold text-lg flex w-full px-3 py-4 md:py-2 md:text-base justify-between items-center bg-popover  text-popover-foreground transition-[outline] drop-shadow-sm drop-shadow-black/50 rounded-full font-heading",
